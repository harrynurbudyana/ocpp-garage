...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('available', 'preparing', 'charging', 'suspended_evse', 'suspended_ev', 'finishing', 'reserved', 'unavailable', 'faulted', name='chargepointstatus'), nullable=True),
